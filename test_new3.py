...
def main():
    # Paths and settings
    checkpoint_path = "/kaggle/input/cp_nondisjoint_train/pytorch/default/1/final.pth"  # Update with your model path
    test_data_path = "/kaggle/input/polyvore-outfits/polyvore_outfits"  # Update with your test data path
